...
\begin{document}
	...
	\begin{quote} {
		...
		\textbullet\quad20190130 / 1.1: Second version: Many new topics added, and there are smaller edits of the original text.\\
		\textbullet\quad20190926 / 1.2: Third version: Minor changes and additions.\\
		\textbullet\quad20191129 / 1.3: Fourth version (this version): Minor changes.\\
		\bigskip
		\textcolor{endretInnhold}{Changes and additions printed in dark red, and with date of change in margin.}
	}
	\end{quote}
	\vfill
	\pagebreak
...
\begin{itemize}
	...
	\item Use the numeric XML annotation of an entity, for example: instead of \entitet{ApplyFunction} or \entitet{af}, use \entitet{\#8289}
