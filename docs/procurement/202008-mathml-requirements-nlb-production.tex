...
\begin{document}
	...
	\begin{quote} {
        ...
        \textbullet\quad20200831 / 2.3: (current version) Update for language and more structure to chemistry markup.\\
        \bigskip
	}
	\end{quote}
	\vfill
...
\begin{itemize}
	...
	\item The language of the generated text is reliant on which \emph{xml:lang}-attribute is set. Thus there must exist an ancestor of the expression with the \emph{xml:lang}-attribute, for example: \element{<html xml:lang="en">}
